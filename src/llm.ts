...
//  sentenceScore: 當前整句話合理與否，-3(非常不合理) 到 3(非常合理)
...
export async function judge(
  ...
  const lines = [
    ...
    "句子是一個字一個字慢慢接出來的，可能還沒接完；不要因為主詞、受詞或整句還沒完整就扣分。最後接上的那個字會用【】標出，【】不算句子內容，判斷時請忽略。",
    "你要輸出兩項判斷：",
    "【句子評分 sentenceScore】這句話目前讀起來有多合理又自然，給 -3 到 3 的整數。三點同時看，任一點差就扣分：",
    "　一、語法是否通順。",
    "　二、意思是否合理、符合常理（例如「太陽在海裡游泳」意思荒謬，要扣分）。",
    "　三、語感是否自然，也就是像不像台灣母語人士會講的話。就算語法沒錯、意思不荒謬，只要唸起來拗口、生硬或詞語硬湊（例如「街邊好區」），也算不自然要扣分。",
    "請從嚴評分，不要因為「勉強說得通」就給高分。基準：3＝通順自然、意思清楚，明顯是母語人士會講的話；1 到 2＝大致通順但平淡；0＝中性、難判斷；-1 到 -2＝生硬拗口、搭配牽強；-3＝意思荒謬、矛盾或完全不通。",
